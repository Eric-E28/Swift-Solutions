...
namespace PopNGo.Controllers.APIs
{
    ...
    public class ItineraryEventApiController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateNewItinerary(string itineraryTitle)
        {
            ...
            _itineraryEventRepository.CreateNewItinerary(pgUser.Id, itineraryTitle);
            return Ok();
        }
        [HttpGet]
        ...
        public async Task<ActionResult<IEnumerable<Models.DTO.Itinerary>>> GetUserEventFromItinerary()
        {
            ...
            IEnumerable<Models.DTO.Itinerary> events = _itineraryEventRepository.GetAllItinerary(pgUser.Id);
        ...
        public async Task<ActionResult> DeleteItinerary(int itineraryId)
        {
            try
            {
                ...
                _itineraryEventRepository.DeleteItinerary(itineraryId);
